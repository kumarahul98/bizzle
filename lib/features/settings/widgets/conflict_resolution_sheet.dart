    ...
    return SafeArea(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(kConflictResolutionTitle, style: Theme.of(context).textTheme.titleLarge),
            ...
            Flexible(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final selectedAction = _resolutions[tripId] ?? kConflictKeepLocal;
                  
                  final isOverlap = conflict is OverlapConflict;
                  final title = isOverlap ? 'Overlap Conflict' : 'Modified Conflict';
