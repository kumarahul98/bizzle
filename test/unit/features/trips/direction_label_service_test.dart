...
void main() {
  group('DirectionLabelService', () {
    ...
    test(
      'hour between morning and evening cutoff returns kDirectionToHome',
      () {
        expect(
    ...
    test(
      'midnight (hour 0) with default cutoffs returns kDirectionToOffice',
      () {
        expect(
    ...
    test(
      'UTC-offset pitfall: 5:30 local time labels as kDirectionToOffice',
      () {
    ...
    test(
      'same morning and evening cutoff: hour equal returns kDirectionToHome',
      () {
