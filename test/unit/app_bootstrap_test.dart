        ...
        await tester.pumpWidget(
          ProviderScope(
            overrides: [
              ...
              //
              // Phase 20: emit a returning-user value (hasSeenOnboarding=true)
              // so the root gate routes AuthGuest → MainShell/DashboardScreen,
              // not the first-run LoginScreen. The gate is covered by
