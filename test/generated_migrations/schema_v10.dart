...
class Trips extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> directionSource = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT \'time\'',
    defaultValue: const CustomExpression('\'time\''),
  );
...
class UserPreferences extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> reminderEnabled = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (reminder_enabled IN (0, 1))',
  ...
  late final GeneratedColumn<String> reminderTime = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NULL DEFAULT \'07:00\'',
  ...
  late final GeneratedColumn<int> weeklyNotificationEnabled =
      GeneratedColumn<int>(
        ...
        requiredDuringInsert: false,
        $customConstraints:
            'NOT NULL DEFAULT 0 CHECK (weekly_notification_enabled IN (0, 1))',
        defaultValue: const CustomExpression('0'),
      );
  late final GeneratedColumn<int> autoPauseEnabled = GeneratedColumn<int>(
    'auto_pause_enabled',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT 1 CHECK (auto_pause_enabled IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
...
class TripBreaks extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TripBreaks(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> tripId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES trips(id)',
  );
  late final GeneratedColumn<int> startTime = GeneratedColumn<int>(
    'start_time',
    aliasedName,
  ...
  @override
  TripBreaks createAlias(String alias) {
    return TripBreaks(attachedDatabase, alias);
  }
...
class TripStuckSegments extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TripStuckSegments(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  TripStuckSegments createAlias(String alias) {
    return TripStuckSegments(attachedDatabase, alias);
  }
...
class DatabaseAtV10 extends GeneratedDatabase {
  ...
  late final TripBreaks tripBreaks = TripBreaks(this);
  late final TripStuckSegments tripStuckSegments = TripStuckSegments(this);
