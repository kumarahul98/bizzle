...
- **Global scope**: `/Users/coolman/Documents/Projects/bizzle/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/coolman/Documents/Projects/bizzle/.claude/notes/`)
...
2. Glob `/Users/coolman/Documents/Projects/bizzle/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/coolman/Documents/Projects/bizzle/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/coolman/Documents/Projects/bizzle/.claude/notes/` — works in any directory
