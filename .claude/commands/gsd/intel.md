...
Intel system is disabled. To activate:
  ...
  node /Users/coolman/Documents/Projects/bizzle/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/coolman/Documents/Projects/bizzle/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/coolman/Documents/Projects/bizzle/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/coolman/Documents/Projects/bizzle/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
