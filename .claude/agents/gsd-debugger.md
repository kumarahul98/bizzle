...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/coolman/Documents/Projects/bizzle/.claude
                  → checks /Users/coolman/Documents/Projects/bizzle/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/coolman/Documents/Projects/bizzle/.claude/get-shit-done
                  → writes to /Users/coolman/Documents/Projects/bizzle/.claude/get-shit-done/hooks/
...
@/Users/coolman/Documents/Projects/bizzle/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/coolman/Documents/Projects/bizzle/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/coolman/Documents/Projects/bizzle/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/coolman/Documents/Projects/bizzle/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/coolman/Documents/Projects/bizzle/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
